...
<p align="center">
  <img src="https://img.shields.io/badge/Count-28-8B5CF6?style=for-the-badge" alt="28 skills" />
...
28 skills across 7 active domains: programming, business, artificial intelligence, devops, web, security, and data. 13 additional domains are reserved for future expansion.
...
Seven domains are active: `01-programming` (16 skills), `02-business` (1), `03-artificial` (4), `04-devops` (1), `05-web` (2), `06-security` (3), and `07-data` (1). Domains `08` through `20` are reserved for future expansion.
