...
<p align="center">
  <img src="https://img.shields.io/badge/Count-33-8B5CF6?style=for-the-badge" alt="33 skills" />
...
33 skills across 8 active domains: programming, business, artificial intelligence, devops, web, security, data, and design. 12 additional domains are reserved for future expansion.
...
Eight domains are active: `01-programming` (16 skills), `02-business` (1), `03-artificial` (4), `04-devops` (1), `05-web` (3), `06-security` (3), `07-data` (1), and `08-design` (4). Domains `09` through `20` are reserved for future expansion.
